...
![image](image/7.19/5.png)

执行git log命令，发现已经回到之前的提交：

![image](image/7.19/6.png)
...
![image](image/7.19/7.png)

效果和方法一一样：

![image](image/7.19/8.png)
